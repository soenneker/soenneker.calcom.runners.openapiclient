...
using Soenneker.CalCom.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.CalCom.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["CalCom:ClientGenerationUrl"] ?? "https://cal.com/docs/api-reference/v1/openapi-v1.json";
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c CalComOpenApiClient -n {Constants.Library}",
